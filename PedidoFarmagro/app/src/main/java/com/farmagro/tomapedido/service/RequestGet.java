...
public abstract class RequestGet extends Thread {
    ...
    public abstract Object readResponse(String str) throws Exception;
    ...
    public RequestGet(Application app) {
    ...
    public Object doRequest() throws IOException {
        ...
        try {
            ...
            if (instream != null) {
                return readResponse(convertStreamToString(instream));
            }
            return Constante.ERROR;
        } catch (Exception e) {
            return Constante.ERROR;
